...
// Predefined FAQ questions and answers from the official FAQ data
const presetFAQs = [
  {
...
export function WhatsappButton() {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      setIsTyping(false);
      // Check if user input matches any FAQ query keywords
  ...
  return (
    <>
      {/* 1. Stretched WhatsApp button moved up to bottom-28 */}
      ...
      {/* 3. Personal Chatbot Modal Popup Window */}
      <AnimatePresence>
        {chatOpen && (
          <motion.div
