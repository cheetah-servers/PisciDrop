              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <input
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-zinc-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 text-sm text-zinc-900 bg-white transition-all"
                    />
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-1.5">
                    ...
                    <select
                      ...
                      className="w-full px-4 py-3 rounded-xl border border-zinc-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 text-sm bg-white text-zinc-900 transition-all"
                    >
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl border border-zinc-200 focus:outline-none focus:border-orange-500 focus:ring-2 focus:ring-orange-500/10 text-sm text-zinc-900 bg-white transition-all resize-none"
                  />
                </div>
